...
let DashboardComponent = class DashboardComponent {
    constructor(_enrollmentService, router) {
        this._enrollmentService = _enrollmentService;
        this.router = router;
        this.errorMsg = '';
    }
    showfood() {
        this._enrollmentService.getFoods().subscribe(data => { this.foods = data; }, err => console.error(err), () => console.log('done loading foods'));
    }
    ngOnInit() {
        this.showfood();
        this.alertfun();
...
let EnrollmentService = class EnrollmentService {
    ...
    enroll(user) {
        return this._http.post(this._url + 'enroll', user)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandler));
    }
    login(luser) {
        return this._http.post(this._url + 'login', luser)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandler));
    }
    getFoods() {
...
module.exports = __webpack_require__(/*! /home/devendra/Videos/node_passport_login-master/client/vehicle/src/main.ts */"./src/main.ts");
